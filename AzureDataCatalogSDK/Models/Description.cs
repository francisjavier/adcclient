...
namespace Microsoft.Azure.DataCatalog.Rest.Models
{
    ...
    /// <summary>
    /// Description property, used to describe assets
    /// </summary>
    ...
    public partial class Description
    {
        ...
        /// Initializes a new instance of the Description class.
        /// </summary>
        /// <param name="descriptionProperty">description property</param>
        /// <param name="fromSourceSystem">fromSourceSystem property</param>
        /// <param name="key">key property</param>
        public Description(string descriptionProperty, bool fromSourceSystem, string key, System.Collections.Generic.IList<RolesItem> roles = default(System.Collections.Generic.IList<RolesItem>))
        {
        ...
        public virtual void Validate()
        {
            ...
            {
                throw new Microsoft.Rest.ValidationException(Microsoft.Rest.ValidationRules.CannotBeNull, "DescriptionProperty");
            }
            if (Key == null)
            {
