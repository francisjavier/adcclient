...
namespace Microsoft.Azure.DataCatalog.Rest.Models
{
    ...
    public partial class FunctionSchemaGet : SystemProperty
    {
        /// <summary>
        /// Initializes a new instance of the FunctionSchemaGet class.
        /// </summary>
        public FunctionSchemaGet() { }
        ...
        public FunctionSchemaGet(FunctionSchemaBodyParameterSet parameterSet, FunctionSchemaBodyResultSet resultSet, bool fromSourceSystem, string id = default(string), string etag = default(string), string timestamp = default(string), System.Collections.Generic.IList<RightsItems?> effectiveRights = default(System.Collections.Generic.IList<RightsItems?>), System.Collections.Generic.IList<RolesItem> roles = default(System.Collections.Generic.IList<RolesItem>))
