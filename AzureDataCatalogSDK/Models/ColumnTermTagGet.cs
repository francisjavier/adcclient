...
namespace Microsoft.Azure.DataCatalog.Rest.Models
{
    ...
    public partial class ColumnTermTagGet : SystemProperty
    {
        /// <summary>
        /// Initializes a new instance of the ColumnTermTagGet class.
        /// </summary>
        public ColumnTermTagGet() { }
        ...
        public ColumnTermTagGet(string columnName, string termId, bool fromSourceSystem, string key, string id = default(string), string etag = default(string), string timestamp = default(string), System.Collections.Generic.IList<RightsItems?> effectiveRights = default(System.Collections.Generic.IList<RightsItems?>), int? resultSetIndex = default(int?), System.Collections.Generic.IList<RolesItem> roles = default(System.Collections.Generic.IList<RolesItem>))
