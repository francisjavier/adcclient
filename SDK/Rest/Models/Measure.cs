...
namespace Microsoft.Azure.DataCatalog.Rest.Models
{
    ...
    public partial class Measure
    {
        ...
        public Measure(string name, string type, int? maxLength = default(int?), string precision = default(string), bool? isNullable = default(bool?), string expression = default(string))
        {
            Name = name;
            Type = type;
            MaxLength = maxLength;
