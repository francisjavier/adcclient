...
namespace Microsoft.Azure.DataCatalog.Rest.Models
{
    ...
    public partial class ParameterTagGet : SystemProperty
    {
        /// <summary>
        /// Initializes a new instance of the ParameterTagGet class.
        /// </summary>
        public ParameterTagGet() { }
        ...
        public ParameterTagGet(string parameterName, string tag, bool fromSourceSystem, string key, string id = default(string), string etag = default(string), string timestamp = default(string), System.Collections.Generic.IList<RightsItems?> effectiveRights = default(System.Collections.Generic.IList<RightsItems?>), System.Collections.Generic.IList<RolesItem> roles = default(System.Collections.Generic.IList<RolesItem>))
