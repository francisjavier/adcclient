...
namespace Microsoft.Azure.DataCatalog.Rest.Models
{
    ...
    public partial class ColumnsDataProfileGet : SystemProperty
    {
        /// <summary>
        /// Initializes a new instance of the ColumnsDataProfileGet class.
        /// </summary>
        public ColumnsDataProfileGet() { }
        ...
        public ColumnsDataProfileGet(bool fromSourceSystem, string key, string id = default(string), string etag = default(string), string timestamp = default(string), System.Collections.Generic.IList<RightsItems?> effectiveRights = default(System.Collections.Generic.IList<RightsItems?>), System.Collections.Generic.IList<ColumnDataProfile> columns = default(System.Collections.Generic.IList<ColumnDataProfile>), System.Collections.Generic.IList<RolesItem> roles = default(System.Collections.Generic.IList<RolesItem>))
