...
namespace Microsoft.Azure.DataCatalog.Rest.Models
{
    ...
    public partial class MeasureGet : SystemProperty
    {
        /// <summary>
        /// Initializes a new instance of the MeasureGet class.
        /// </summary>
        public MeasureGet() { }
        ...
        /// <param name="isCalculated">isCalculated property</param>
        ...
        public MeasureGet(string name, Dsl dsl, DataSource dataSource, LastRegisteredBy lastRegisteredBy, bool fromSourceSystem, Measure measure, bool isCalculated, string id = default(string), string etag = default(string), string timestamp = default(string), System.Collections.Generic.IList<RightsItems?> effectiveRights = default(System.Collections.Generic.IList<RightsItems?>), System.Collections.Generic.IList<RolesItem> roles = default(System.Collections.Generic.IList<RolesItem>), double? containerId = default(double?), string measureGroup = default(string), System.Collections.Generic.IList<Description> descriptions = default(System.Collections.Generic.IList<Description>), System.Collections.Generic.IList<Expert> experts = default(System.Collections.Generic.IList<Expert>), AccessInstruction accessInstructions = default(AccessInstruction), Documentation documentation = default(Documentation), FriendlyName friendlyName = default(FriendlyName), System.Collections.Generic.IList<Tag> tags = default(System.Collections.Generic.IList<Tag>), System.Collections.Generic.IList<TermTag> termTags = default(System.Collections.Generic.IList<TermTag>))
        ...
        /// <summary>
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.measure")]
        public Measure Measure { get; set; }

        /// <summary>
        /// Gets or sets isCalculated property
        /// </summary>
        [Newtonsoft.Json.JsonProperty(PropertyName = "properties.isCalculated")]
